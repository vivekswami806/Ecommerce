     ...
     {cart.length >0 && ( <div className="container">
        ...
        <div className="container bg-light"  style={{height:"40vh",width:"30%"}}>
          <div className="row d-flex justify-content-end" >
            <div className="col">
            <p>SubTotal:  <span style={{fontWeight:"600"}}>{ totalPrice}</span></p>
            <p>Shipping Price: <span style={{fontWeight:"600"}}>{ shipping_price}</span></p>
            <br/>
            <hr/>
            <p> Total Order Price: <span style={{fontWeight:"600"}}>{shipping_price +  totalPrice}</span></p>
            </div>
          </div>
